...
const Checkout = ({ cart, updateCart, setOrderHistory }) => {
  ...
  const scrollToConfirmOrderButton = () => {
    if (
      ...
      validatePhoneNumber(billingDetails.phoneNumber) &&
            ...
            ${cart
              ...
              <tr>
                <td style="border: 1px solid #ddd; padding: 8px;">
                  ${product.name}<br>
              <span style="color: #666; font-size: 0.9em;">ID: ${
                product.id
              }</span>
                ...
                <td style="border: 1px solid #ddd; padding: 8px;">
                  <div style="display: flex; align-items: center;">
                    ...
                    <div>
                      ...
                      <div><span style="color: #666; font-size: 0.9em;"><strong>ID:</strong> ${
                        product.id
                      }</span></div>
                    </div>
                  </div>
      ...
      billingDetails.deliveryArea === "insideDhaka"
        ...
        : "Outside Dhaka"
              ...
              <div style="display: flex; justify-content: space-between; font-size: 18px; font-weight: bold; margin-top: 15px; padding-top: 10px; border-top: 1px solid #eee;">
                ...
                <span style="color: #000000;">৳${formatPrice(totalPrice)}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <br><br><div style="color: #333; padding: 20px; text-align: center; font-size: 14px;">
          <p style="margin: 0; font-weight: bold;">© 2025 <span style="color: #08ad74;">BasicVibe</span>.</p>
        </div>
      </div>
    `;
      ...
      <div className="container">
        ...
        <div className="rightt">
          ...
          <div className="summary">
            <p>
              Subtotal: <strong>৳{formatPrice(calculateSubtotal())}</strong>
            </p>
            <p>
              Delivery Charge:{" "}
              <span style={{ color: "orange" }}>
            ...
            <p className="total">
              Total: (BDT) <strong>৳{formatPrice(totalPrice)}</strong>
            </p>
          </div>
