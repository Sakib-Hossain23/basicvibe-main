    ...
    <div className="wrapper">
      <section className={styles.legalSection}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            ফেরতের সময় পণ্যটি অব্যবহৃত, অক্ষত ও মূল প্যাকেজিংসহ থাকতে হবে।
          </li>

          <li>
            ত্রুটিপূর্ণ বা ভুল পণ্য ছাড়া অন্য সকল ক্ষেত্রে কুরিয়ার চার্জ
            গ্রাহককে বহন করতে হবে।
          </li>
          <li>
          ...
          <li>
            রিটার্ন সংক্রান্ত যেকোনো সাহায্যের জন্য আমাদের কাস্টমার সার্ভিস
